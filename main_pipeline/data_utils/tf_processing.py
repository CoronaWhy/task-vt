# Temporary storage for utils used in the processing of local data structures using tensorflow, TODO are in place for code that probably shouldn't be modified until proper testing can be implemented
