#-*- coding: utf-8 -*-
"""
Utility functions used across different modules in CORD-19
knowledge graph relation extraction project.
"""
import logging
import os
import sys

def setup_logger(folder=None, name='cord', level=logging.INFO):
